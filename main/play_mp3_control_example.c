...
// low rate mp3 audio
extern const uint8_t lr_mp3_start[] asm("_binary_fuck_pcm_start");
extern const uint8_t lr_mp3_end[]   asm("_binary_fuck_pcm_end");
...
void app_main(void) {
    ...
    pcm_decoder_cfg_t mp3_cfg = DEFAULT_PCM_DECODER_CONFIG();
    mp3_cfg.channels=1;
    mp3_cfg.rate=16000;
    mp3_decoder = pcm_decoder_init(&mp3_cfg);
